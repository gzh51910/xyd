    ...
    <ul class="formCom">
      ...
      <li class="icon-arrow">
        ...
        <select v-model='data.selectBind1'>
          <option v-for='option of optionBind' :key="option.defBind1" :value='option.val'>{{option.txt}}</option>
        </select>
      </li>
      <li>
        <label>
    ...
    <ul class="formCom">
      ...
      <li class="icon-arrow">
        ...
        <select v-model='data.selectBind2'>
          <option v-for='option of optionBind' :key="option.defBind2" :value='option.val'>{{option.txt}}</option>
        </select>
      </li>
      <li>
        <label>
    ...
    <ul class="formCom">
      ...
      <li class="icon-arrow">
        ...
        <select v-model='data.selectBind3'>
          <option v-for='option of optionBind' :key="option.optionBind3" :value='option.val'>{{option.txt}}</option>
        </select>
      </li>
      <li>
        <label>
