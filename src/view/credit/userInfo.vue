    ...
    <ul class="formCom">
      ...
      <li class="icon-arrow">
        ...
        <select v-model='data.selectSex'>
          <option v-for='option in optionSex' :key="option.optionSex" :value='option.val'>{{option.txt}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>学历</span>
        ...
        <select v-model='data.selectEdu'>
          <option v-for='option in optionEdu' :key="option.optionEdu" :value='option.val'>{{option.txt}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>婚姻状况</span>
        ...
        <select v-model='data.selectMar'>
          <option v-for='option in optionMar' :key="option.optionMar" :value='option.val'>{{option.txt}}</option>
        </select>
      </li>
    </ul>
    ...
    <ul class="formCom">
      <li class="icon-arrow">
        ...
        <select v-model='data.selectProy'>
          <option v-for="option in optionProy" :key="option.optionProy" :value="option.code">{{option.address}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>市</span>
        ...
        <select v-model='data.selectCity'>
          <option v-for="option in optionCity" :key="option.optionCity" :value="option.code">{{option.address}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>区</span>
        ...
        <select v-model='data.selectDist'>
          <option v-for="option in optionDist" :key="option.optionDist" :value="option.code">{{option.address}}</option>
        </select>
      </li>
      <li>
        <label>
